...
namespace AirStrikeKit
{
    ...
    {
        public bool RotateAlongTarget = true;
        public GameObject Target;
        // player ( Your Plane)
        public GameObject[] Cameras;
        // all cameras in the game ( in case of able to swith the views).
        ...
        // position offset between plan and camera
        ...
        void FixedUpdate()
        {
            ...
            if (RotateAlongTarget)
                this.transform.rotation *= Quaternion.Euler(0, 0, Target.transform.rotation.eulerAngles.z);
